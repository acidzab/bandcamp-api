...
def get_json(url, debugging: bool = False):
    ...
    header = {'User-Agent': f'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:128.0) Gecko/20100101 Firefox/128.0/5.0'}
...
class Story():
    def __init__(self, story_url: str):
        ...
        response = requests.get(story_url, headers={'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:128.0) Gecko/20100101 Firefox/128.0'})
